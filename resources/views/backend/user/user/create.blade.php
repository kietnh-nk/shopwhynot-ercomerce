            ...
            <div class="row">
                <div class="col-12">
                    <div
                        ...
                        <h4 class="mb-sm-0">Thêm mới thành viên</h4>
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="name" id=""
                                        value="{{ old('name') }}" placeholder="Tên thành viên">
                                    @if ($errors->has('name'))
                                            ...
                                            <div class="col-lg-4">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="email" class="form-control"
                                                        id="" value="{{ old('email') }}"
                                                        placeholder="Nhập email cho nhóm">
                                                    @if ($errors->has('email'))
                                                        <span
                                        ...
                                        <div class="row">
                                            <div class="mb-3 col-6">
                                                ...
                                                <div class="input-group flex-nowrap">
                                                    <input type="password" class="form-control input-group-password" id="password-input"
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select select2" name="user_catalogue_id">
                                        ...
                                        @foreach ($userCatalogue as $key => $val)
                                            <option value="{{ $val->id }}" {{ old('user_catalogue_id')  == $val->id ? 'selected' : ''}}>{{ $val->name }}</option>
                                        @endforeach
                                    </select>
                                    ...
                                    <div class="text-center">
                                        <div class="position-relative d-inline-block">
                                            ...
                                            <span class="image-target">
                                                <img src="{{ old('image', '/libaries/upload/images/img-notfound.png') }}"
                                                    alt=""
