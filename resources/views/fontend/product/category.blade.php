                        ...
                        <div class="filter-product-item">
                            <div class="d-flex justify-content-between">
                                ...
                                <a href="{{ route('product.category', ['id' => request('id')]) }}"
                                    class="fz-14 text-danger">Bỏ lọc</a>
                            </div>
                            <form>
                                                ...
                                                <div class="card-body p-2">
                                                    ...
                                                    <div class="box-action">
                                                        <a href="{{ route('cart.index') }}"
                                                            ...
                                                            data-id="{{ $product->id }}" data-product-variant-id="{{ $variantFirst ? $variantFirst->id : '' }}" data-product-variant-price="{{ $variantFirst ? $variantFirst->price : $productPriceMin->price }}" data-attributeId="{{ $variantFirst ? @json_encode($variantFirst->code) : '' }}">
                                    ...
                                    <div class="card card-product shadow-sm border-0 mb-2 py-0">
                                        ...
                                        <div class="card-body p-2">
                                            ...
                                            <div class="box-action">
                                                <a href="{{ route('cart.index') }}"
                                                    class="action-cart-item-buy addToCart buyNow"
                                                    data-id="{{ $productNew->id }}" data-product-variant-id="{{ $variantFirst ? $variantFirst->id : '' }}" data-product-variant-price="{{ $variantFirst ? $variantFirst->price : $productPriceMin->price }}" data-attributeId="{{ $variantFirst ? @json_encode($variantFirst->code) : '' }}">
                                                    <i class="fa-solid fa-cart-shopping fz-18 me-2"></i>
                                                    <span>Mua ngay</span>
                                                </a>
                                                <a href="" class="action-cart-item-add addToCart"
                                    ...
                                    <div class="card card-product shadow-sm border-0 mb-2 py-0">
                                        ...
                                        <div class="card-body p-2">
                                            ...
                                            <div class="box-action">
                                                <a href="{{ route('cart.index') }}"
                                                    class="action-cart-item-buy addToCart buyNow"
                                                    data-id="{{ $productPriceMin->id }}" data-product-variant-id="{{ $variantFirst ? $variantFirst->id : '' }}" data-product-variant-price="{{ $variantFirst ? $variantFirst->price : $productPriceMin->price }}" data-attributeId="{{ $variantFirst ? @json_encode($variantFirst->code) : '' }}">
                                                    <i class="fa-solid fa-cart-shopping fz-18 me-2"></i>
                                                    <span>Mua ngay</span>
                                                </a>
                                                <a href="" class="action-cart-item-add addToCart"
