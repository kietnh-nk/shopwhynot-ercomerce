            ...
            <div class="container">
                <div class="d-flex justify-content-between align-items-center p-2 fz-15">
                    ...
                    <div class="fw-medium d-none d-lg-block">
                        ...
                        <span class="ms-2">Hotline: <a href="tel:{{ env('PHONE') }}">{{ env('PHONE') }}</a></span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <nav class="navbar navbar-expand-lg shadow-sm bg-white p-0 sticky-nav">
                <div class="container p-0">
                    <a class="navbar-brand" href="{{ route('home.index') }}">
                        ...
                        <img src="{{ env('LOGO') }}" class="object-fit-contain logo-index"
                        alt="">
                                    ...
                                    <ul class="ul-menu p-0 mb-1 text-muted z-3">
                                        ...
                                        <li class="li-menu-header p-2">
                                            <a href="{{ route('profile.user') }}"
                                                class="text-decoration-none fz-13 text-muted custom-a"
                                        ...
                                        @if ($user->user_catalogue_id == 2)
                                            <li class="li-menu-header p-2">
                                                <a href="{{ route('dashboard.index') }}"
                                                    class="text-decoration-none fz-13 ps-1 custom-a">
                                        ...
                                        <li class="li-menu-header p-2">
                                            <a href="{{ route('auth.logout') }}"
                                                class="text-decoration-none fz-13 ps-1 text-danger custom-a">
                                                <i
