<section>
    <div class="container-fuild z-0 pt-5 mt-5" style="background-color: #c3c3c3">
        <div class="container">
            <div class="row flex-grow">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    ...
                    <ul class="p-0">
                        ...
                        <li class="list-unstyled menu-footer-item pt-2 pb-2">
                            <a href="https://zalo.me/{{env('PHONE')}}"
                                class="text-decoration-none text-dark fz-15 fw-normal">Liên hệ zalo: {{env('PHONE')}}</a>
                        </li>
                        <li class="list-unstyled menu-footer-item pt-2 pb-2">
                            <a href="{{ route('home.faq') }}" class="text-decoration-none text-dark fz-15 fw-normal">Câu
                                hỏi thường
                                gặp</a>
                        </li>
                    </ul>
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <h6 class="text-uppercase fw-bold fz-16">Liên hệ chúng tôi</h6>
                    <style>
                        .card-footer {
                            gap: 5px;
                        }
                    ...
                    <div class="card-footer mb-3">
                        ...
                        <a href="https://zalo.me/{{ env('PHONE') }}">
                            ...
                            <img style="width: 50px" src="{{ asset('libaries/icon/zalo.png') }}" alt="">
                        </a>

                        <a href="{{ env('FACEBOOK') }}">

                            <img style="width: 50px" src="{{ asset('libaries/icon/facebook.png') }}" alt="">
                        </a>

                        <a href="tel:{{ env('PHONE') }}">

                            <img style="width: 50px" src="{{ asset('libaries/icon/phone.png') }}" alt="">
                        </a>
            ...
            <div class="row mt-3">
                <div class="col-lg-9 col-md-6 col-sm-6">
                    <span class="text-decoration-none text-dark fz-15 fw-normal">@2025 phát triển toàn
                        diện</span>
                    <ul class="d-flex justify-content-start  align-items-center p-0">
                        <li class="list-unstyled menu-footer-item pt-2 pb-2 me-2">
                            <a href="{{ route('home.security_center') }}"
                                class="text-decoration-underline text-dark fz-15 fw-medium ">Chính sách bảo mật</a>
                        </li>
                    </ul>
                </div>
                    ...
                    <ul class="p-0 d-flex justify-content-sm-around align-items-center w-75">
                        <li class="list-unstyled menu-footer-item pt-2 ps-0 pb-2">
                            <a href="#" class="text-decoration-none text-dark fz-20 fw-normal">
                                <img src="/libaries/templates/bee-cloudy-user/libaries/images/pay.svg" alt=""
                                    class="w-100" data-bs-toggle="tooltip" data-bs-title="Các phuong thức thanh toán">
                            </a>
                        </li>
                    </ul>
                </div>
    ...
    <tfoot>
        <div class="container-fuild text-bg-dark">
            <div class="container text-lg-center p-2">
                <span class="p-2 fz-14">Bản quyền thuộc © laptrinhvien - 2025</span>
            </div>
        </div>
    </tfoot>
</section>
