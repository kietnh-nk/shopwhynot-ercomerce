(function ($) {
    ...
    //         let originalText = _this.text();
    //         _this.text('Đang thêm...');
    ...
    //             });
    //         } else {
    //             // Xử lý Add to Cart thông thường
    //             $.ajax({
    //                 url: "/ajax/cart/addToCart",
    //                 type: "POST",
    //                 data: options,
    ...
    //                         flasher.success(res.message || 'Sản phẩm đã được thêm vào giỏ hàng');

    //                         // Cập nhật số lượng giỏ hàng trong header (nếu có)
    //                         if (res.cartItem && res.cartItem.length > 0) {
    //                             updateCartCount(res.cartItem.length);

    //                             // Có thể thêm animation cho button
    ...
    //                         $(document).trigger('cartUpdated', [res.cartItem]);

    //                     } else {
    //                         flasher.error(res.message || 'Có lỗi xảy ra khi thêm sản phẩm');
    //                     }
    //                 },
    //                 error: function (xhr) {
    //                     // Reset button
    ...
    //                         }, 2000);
    //                     } else {
    //                         flasher.error(response.message || 'Có lỗi xảy ra khi thêm sản phẩm');
    //                     }
    //                 },
    //             });
    //         }
